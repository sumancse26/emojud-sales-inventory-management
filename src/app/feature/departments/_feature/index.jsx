...
export default function DepartmentsFeature({ initialList = [], userInfo }) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between gap-4">
                <div>
                    <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Departments</h2>
                    <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                        Manage all departments in your organisation
                    </p>
                </div>
                <button
                    onClick={openCreate}
            ...
            <DepartmentTable items={filtered} onEdit={openEdit} />
