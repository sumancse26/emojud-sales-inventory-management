...
export default function RolesFeature({ initialList = [], userInfo }) {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between gap-4">
                <div>
                    <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Roles</h2>
            ...
            <RoleTable items={filtered} onEdit={openEdit} />
