...
export default function ProductCategoryFeature({ initialList = [], categories = [], userInfo }) {
    ...
    const filtered = useMemo(() => {
        ...
        return initialList.filter(item =>
            ...
            item.parent_category_name?.toLowerCase().includes(q)
        );
    }, [initialList, query]);
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between gap-4">
                <div>
                    <h2 className="text-xl font-bold text-slate-900 dark:text-slate-100">Product Categories</h2>
            ...
            {/* Table */}
            <CategoryTable items={filtered} onEdit={openEdit} />
